package com.rush_rooms.ui.ConfirmYourEmail
...
import com.rush_rooms.databinding.ActivityConfirmYourEmailBinding
...
class ConfirmYourEmailActivity : AppCompatActivity() {
    lateinit var binding: ActivityConfirmYourEmailBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityConfirmYourEmailBinding.inflate(layoutInflater)
    ...
    private fun lstnr() {
        ...
        binding.edittext1.setOnKeyListener(
            ConfirmYourMobileActivity.GenericKeyEvent(
                binding.edittext1,
                null
            )
        )
