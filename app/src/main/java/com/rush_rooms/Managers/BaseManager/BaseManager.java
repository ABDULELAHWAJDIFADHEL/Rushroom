...
import static com.rush_rooms.Constants.MyConstants.kAppPreferences;
...
public class BaseManager {
    ...
    public synchronized static void saveDataIntoPreferences(Object dataObject, String key)   {
        ...
        SharedPreferences sharedPreferences = com.rush_rooms.Managers.BaseManager.ApplicationManager.getContext().getSharedPreferences(kAppPreferences, Context.MODE_PRIVATE);
    ...
    public static String getAppName()   {
        ...
        try {
            ApplicationInfo applicationInfo = com.rush_rooms.Managers.BaseManager.ApplicationManager.getContext().getApplicationInfo();
            int stringId = applicationInfo.labelRes;
            appName = (stringId == 0 ? applicationInfo.nonLocalizedLabel.toString() :com.rush_rooms.Managers.BaseManager.ApplicationManager.getContext().getString(stringId));
        }catch (Exception e)    {
            e.printStackTrace();
        }
        finally {
